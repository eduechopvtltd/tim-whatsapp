        ...
        if (messageType === 'text') {
          ...
          if (compData.header.type) {
            ...
            if (['IMAGE', 'VIDEO', 'DOCUMENT'].includes(compData.header.type)) {
              ...
              console.log('header_media_url mapping:', mapping.header_media_url);
              console.log('mappedMediaUrl:', mappedMediaUrl);
              console.log('contact[mapping.header_media_url]:', contact[mapping.header_media_url]);
